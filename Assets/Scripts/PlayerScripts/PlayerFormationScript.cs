...
public class PlayerFormationScript : MonoBehaviour
{
    [Header(" Components ")]
    [SerializeField] private TextMeshPro playerAmountText;
    ...
    [Header(" Settings ")]
    [SerializeField] private PlayerRunnerScript runnerPrefab;
    ...
    void Update()
    {
        ...
        playerAmountText.text = transform.childCount.ToString();
    }
    ...
    public void AddRunners(int amount)
    {
        ...
        {
            PlayerRunnerScript runnerInstance = Instantiate(runnerPrefab, transform);
